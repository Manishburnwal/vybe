  ...
  return (
    <div className='w-full flex justify-between items-center p-[5px] min-h-[50px] bg-gray-800 rounded-full'>
        <div className='flex gap-[10px] items-center'>
            <div className='w-[40px] h-[40px] rounded-full overflow-hidden cursor-pointer border-2 border-black'>
        ...
        <div className='w-[40px] h-[40px] rounded-full overflow-hidden border-4 border-black'>
            ...
            :
            noti?.post?
            <video src={noti?.post?.media} muted loop className='h-full object-cover'/>:null}
